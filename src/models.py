...
class AAE1(Base):
	...
	def export_model(self, filepath):
		...
		self.autoencoder.save(filepath + 'autoencoder_AAE1.h5')
		self.generator.save(filepath + 'generator_AAE1.h5')
		self.discriminator.save(filepath + 'discriminator_AAE1.h5')
		self.encoder.save(filepath + 'encoder_AAE1.h5')
		self.decoder.save(filepath + 'decoder_AAE1.h5')
